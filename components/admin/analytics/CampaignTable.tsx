        ...
        <table className="min-w-full text-left text-sm text-white/85">
          ...
          <tbody>
            {sortedRows.length === 0 ? (
              ...
              sortedRows.map((row) => (
                <tr key={row.key} className="border-t border-white/5 odd:bg-white/[0.02] hover:bg-white/[0.06]">
                  ...
                  <td className="px-3 py-2.5 font-semibold text-spotify-400">{row.qualifiedRatePct}%</td>
                </tr>
              ))
            )}
          </tbody>
